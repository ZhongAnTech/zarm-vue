...
<script>
import { arrayTreeFilter, formatToInit, formatBackToObject, isArray, hasChildrenObject } from '@/utils/validator';
...
export default {
  ...
  methods: {
    ...
    onInit(selected) {
      // console.log('onInit',selected) // eslint-disable-line
